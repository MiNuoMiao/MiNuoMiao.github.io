...
$.ajax({
  ...
  data: {
    key: 'SYMBZ-NNXCJ-K6IFR-KVZTM-YJFIK-QGFUR',
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome () {
  ...
  let dist = getDistance(104.110853, 30.683003, ipLoacation.result.location.lng, ipLoacation.result.location.lat) //这里换成自己的经纬度
